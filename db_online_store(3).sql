/*
 ...
 Source Schema         : db_online_store

 Target Server Type    : MySQL
 Target Server Version : 50642
 File Encoding         : 65001

 Date: 28/12/2019 18:10:45
*/
...
CREATE TABLE `t_administrator`  (
  ...
  `account` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '管理员账号',
  `password` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '管理员密码',
...
INSERT INTO `t_category` VALUES (7, '最代码');
...
CREATE TABLE `t_order`  (
  ...
  `telephone` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '收货人手机号',
  `address` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '收货人地址',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `t_order` VALUES ('122002677720191223164638', 2, '2019-12-28 18:07:42', 2299.00, 2, 'sas', 'sas', 'sasa');
INSERT INTO `t_order` VALUES ('208081423720191228180119', 2, '2019-12-28 18:01:47', 2299.00, 0, '最代码', '13520109202', '北京最代码科技有限公司');
...
INSERT INTO `t_order_detail` VALUES (35, '208081423720191228180119', 50, 1, 2299.00);
...
INSERT INTO `t_product` VALUES (57, 7, '最代码牛币', 50.00, 20.00, 'products/7/C/A6059993BD764472A13DF41F26F8E8DA.png', 'zuidaima.com的牛币', '2019-12-28', 1, 0, 20000);
...
CREATE TABLE `t_user`  (
  ...
  `sex` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户性别',
  `email` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户邮箱',
  `telephone` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户手机号',
  `birthday` date DEFAULT NULL COMMENT '用户生日',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `unique_user_account`(`account`) USING BTREE,
  UNIQUE INDEX `unique_user_email`(`email`) USING BTREE,
  UNIQUE INDEX `account`(`account`) USING BTREE,
  UNIQUE INDEX `email`(`email`) USING BTREE,
  UNIQUE INDEX `unique_user_telephone`(`telephone`) USING BTREE,
