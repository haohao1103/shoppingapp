...
<form name="Form1" method="post" action="name.aspx" id="Form1">
	...
	<table width="100%" border="0" height="100%" border="1" background="${pageContext.request.contextPath}/Resource/images/back1.JPG">
		<tr>
			<td colspan=3 class="ta_01" align="center" bgcolor="#afd1f3" style="font-size: xx-large;" height="10%"><strong>系统首页</strong></td>
		</tr>

		<tr>
			<td width="65%" height="90%" align="center" valign="middle" >
				<h3 class="Style1" style="font-family: 华文行楷; font-size: x-large;">欢迎进入电子商务系统管理中心</h3>
			</td>
		</tr>
